...
<div class="fourth_box">
      ...
      <figure className="flexit">
          ...
          <video  className="imagefix1" controls=""
            ...
            muted
            loop/>
<figcaption className="fig">5 minute office makeup look <br/>kaise karte hai?</figcaption>
      ...
      <figure className="flexit">
        {/* <iframe className="imagefix1" width="60%" src="https://www.youtube.com/watch?v=kblDyxQPMRA?autoplay=1" allow='autoplay' alt="abc.png" >
          ...
          <video  className="imagefix1" controls=""
            ...
            muted
            loop/>
            <figcaption className="fig">Makeup V/S No Makeup look</figcaption>
        </figure>
      </Carousel.Item>
      <Carousel.Item>
      <figure className="flexit">
        {/* <iframe className="imagefix1" width="60%" src="https://www.youtube.com/watch?v=kblDyxQPMRA?autoplay=1" allow='autoplay' alt="abc.png" >
          ...
          <video  className="imagefix1" controls=""
            ...
            muted
            loop/>
            <figcaption className="fig">5 minute mein wedding guest makeup look kaise kare?</figcaption>
        </figure>
      </Carousel.Item>
      <Carousel.Item>
      <figure className="flexit">
        {/* <iframe className="imagefix1" width="60%" src="https://www.youtube.com/watch?v=kblDyxQPMRA?autoplay=1" allow='autoplay' alt="abc.png" >
          ...
          <video  className="imagefix1" controls=""
            ...
            muted
            loop/>
            <figcaption className="fig">Quick 5 minute glam makeup</figcaption>
        </figure>
      </Carousel.Item>
      <Carousel.Item>
      <figure className="flexit">
        {/* <iframe className="imagefix1" width="60%" src="https://www.youtube.com/watch?v=kblDyxQPMRA?autoplay=1" allow='autoplay' alt="abc.png" >
          ...
          <video  className="imagefix1" controls=""
            ...
            muted
            loop/>
            <figcaption className="fig">Jawline Contouring Guide</figcaption>
        </figure>
      </Carousel.Item>
      <Carousel.Item>
      <figure className="flexit">
     ...
     <div class="fourth_box">
      ...
      <Carousel.Item>
      <div className="flexit">
        <img className="imagefix" width="60%" src="https://cdn.shopify.com/s/files/1/0906/2558/products/1_d9962984-085d-407e-82b6-3fcc257d313f.jpg?v=1649865685" alt="abc.png"/>
        <h4>MATTE PRIMBLING BAR</h4>
      <p className="ptagfix">₹ 299.00</p>
        <button className="btnfix">SELECT SHADE</button>
        </div>
